...
from electrum_nyc_gui.kivy.i18n import _
from electrum_nyc.paymentrequest import InvoiceStore
from electrum_nyc.util import profiler, InvalidPassword
...
#Factory.register('InstallWizard', module='electrum_nyc_gui.kivy.uix.dialogs.installwizard')
#Factory.register('InfoBubble', module='electrum_nyc_gui.kivy.uix.dialogs')
#Factory.register('OutputList', module='electrum_nyc_gui.kivy.uix.dialogs')
#Factory.register('OutputItem', module='electrum_nyc_gui.kivy.uix.dialogs')
...
Factory.register('TabbedCarousel', module='electrum_nyc_gui.kivy.uix.screens')
...
from electrum_nyc.util import base_units
...
class ElectrumWindow(App):
    ...
    def choose_server_dialog(self, popup):
        ...
        protocol = 's'
        def cb2(host):
            from electrum_nyc.bitcoin import NetworkConstants
    ...
    def _get_bu(self):
        return self.electrum_config.get('base_unit', 'NYC')
    ...
    def init_ui(self):
        ...
        Factory.register('AnimatedPopup',
                         module='electrum_nyc_gui.kivy.uix.dialogs')
        Factory.register('QRCodeWidget',
                         module='electrum_nyc_gui.kivy.uix.qrcodewidget')
