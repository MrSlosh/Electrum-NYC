...
;Variables
  ...
  !define PRODUCT_WEB_SITE "https://github.com/pooler/electrum-nyc"
...
;Interface Settings
  ...
  !define MUI_ICON "tmp\electrum-nyc\icons\electrum.ico"
...
Section
  ...
  WriteRegStr HKCU "Software\Classes\litecoin\shell\open\command" "" "$\"$INSTDIR\electrum-nyc-${PRODUCT_VERSION}.exe$\" $\"%1$\""
